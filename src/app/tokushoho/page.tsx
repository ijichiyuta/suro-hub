  ...
  return (
    <LegalShell title="特定商取引法に基づく表記" updated="2026年8月5日">
      ...
      <dl>
        ...
        <dt>解約・返金について</dt>
        <dd>次回更新日の前までにお手続きいただくことで、いつでも解約できます。デジタルサービスの性質上、会員都合による中途解約時の返金（日割りを含む）は原則行いません。ただし、当方都合でサービスを終了する場合、年額プランの未経過期間分を日割りで返金します（利用規約第6条）。</dd>

        <dt>動作環境</dt>
        <dd>最新のモダンブラウザ（Google Chrome / Safari 等）でのご利用を推奨します。</dd>

        <dt>販売数量の制限等</dt>
        <dd>本サービスは招待制です。招待された方のみご登録いただけます。</dd>
      </dl>
    </LegalShell>
  );
}
