// nerai-apply.mjs — 狙い目リライトの再組立＋情報不変検証(単一ソース)。
...
function apply(id) {
  ...
  const baseUnion = numSet(raw.nerai || "");
...
if (!ids.length) { console.error("usage: node nerai-apply.mjs <id> [id...]"); process.exit(1); }
